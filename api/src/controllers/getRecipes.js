...
const getApiInfo = async () =>{
    try {
        let recipes = (await axios(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${process.env.YOUR_API_KEY5}&addRecipeInformation=true&number=100`)).data.results 
